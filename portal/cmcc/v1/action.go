...
import (
	...
	portal "github.com/xjplke/aaa/portal/cmcc"
)

//Version Version
type Version struct{}

//NewChallengeRsp NewChallengeRsp
func (v *Version) NewChallengeRsp(userip net.IP, secret string) portal.Message {
	return newMessage(portal.ACK_CHALLENGE, userip, secret, 0, 0)
}

func (v *Version) NewAuthRsp(userip net.IP, secret string) portal.Message {
	return newMessage(portal.ACK_AUTH, userip, secret, 0, 0)
}

//NewLogoutRsp NewLogoutRsp
func (v *Version) NewLogoutRsp(userip net.IP, secret string) portal.Message {
	return newMessage(portal.ACK_LOGOUT, userip, secret, 0, 0)
}

//NewAffAckAuth NewAffAckAuth
...
//NewReqInfoRsp NewReqInfoRsp
func (v *Version) NewReqInfoRsp(userip net.IP, secret string) portal.Message {
	msg := newMessage(portal.REQ_INFO, userip, secret, 0, 0)
...
func (v *Version) NewAuth(userip net.IP, secret string, username []byte, userpwd []byte, req uint16, cha []byte) portal.Message {
	msg := newMessage(3, userip, secret, 0, req)
